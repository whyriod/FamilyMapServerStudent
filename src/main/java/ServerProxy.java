...
public class ServerProxy {
    ...
    /***
     * Constructor for ServerProxy. Takes hostname and port.
     *
     * @param hostname - hostname for website
     ...
     * @return - The result from the server.
     */
    PersonsResult persons(AuthRequest r){
     ...
     * @return - The result from the server.
     */
    EventsResult events(AuthRequest r){
